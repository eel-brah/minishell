...
simple_tests = {
        ...
        "wildcard 22": 'echo *$Makefile.c',
        "wildcard 23": 'echo Make$sdfsdf*',
        "wildcard 24": "echo $USER''$l'$'$",
        "wildcard 25": 'echo "$USER======"',
        "wildcard 26": 'echo "$======"',
...
# export 8kkk=99
# echo $?
# export XX=99 KK=00 99xx=99 LLL=8989
# echo $?
...
# If PATH is just PATH= or PATH

# Echo hello > test1 test2
# Touch hhhz kkkkz lllllz
# Echo hello > *z 
# z=*z
# Echo hello > $z
