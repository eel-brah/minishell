...
builts = {
	"test builts":"echo hello world",
	"test builts":"echo \"hello world\"",
	"test builts":"echo 'hello world'",
	"test builts":"echo hello'world'",
	"test builts":"echo hello\"\"world",
	"test builts":"echo ''",
	"test builts":"echo \"$PWD\"",
	"test builts":"echo '$PWD'",
	"test builts":"echo \"aspas ->'\"",
	"test builts":"echo \"aspas -> ' \"",
	"test builts":"echo 'aspas ->\"'",
	"test builts":"echo 'aspas -> \" '",
	"test builts":"echo \"> >> < * ? [ ] | ; [ ] || && ( ) & # $ \ <<\"",
	"test builts":"echo '> >> < * ? [ ] | ; [ ] || && ( ) & # $ \ <<'",
	"test builts":"echo \"exit_code ->$? user ->$USER home -> $HOME\"",
	"test builts":"echo 'exit_code ->$? user ->$USER home -> $HOME'",
	"test builts":"echo \"$\"",
	"test builts":"echo '$'",
	"test builts":"echo $",
	"test builts":"echo $?",
	"test builts":"echo $?HELLO",
	"test builts":"pwd",
	"test builts":"pwd oi",
	"test builts":"export hello",
	"test builts":"export HELLO=123",
	"test builts":"export A-",
	"test builts":"export HELLO=123 A",
	"test builts":"export HELLO=\"123 A-\"",
	"test builts":"export hello world",
	"test builts":"export HELLO-=123",
	"test builts":"export =",
	"test builts":"export 123",
	"test builts":"unset",
	"test builts":"unset HELLO",
	"test builts":"unset HELLO1 HELLO2",
	"test builts":"unset HOME",
	"test builts":"unset PATH",
	"test builts":"unset SHELL",
	"test builts":"cd $PWD",
	"test builts":"cd $PWD hi ",
	"test builts":"cd 123123",
	"test builts":"exit 123",
	"test builts":"exit 298",
	"test builts":"exit +100",
	"test builts":"exit \"+100\"",
	"test builts":"exit +\"100\"",
	"test builts":"exit -100",
	"test builts":"exit \"-100\"",
	"test builts":"exit -\"100\"",
	"test builts":"exit hello",
	"test builts":"exit 42 world",
}
tests = {
	"normal test 1": "echo $?",
